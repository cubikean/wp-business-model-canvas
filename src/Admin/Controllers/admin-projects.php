    ...
    <?php if ($supervisor_filter == 0): ?>
        ...
        <div class="wp-bmc-section">
            ...
            <form id="create-project-form" class="wp-bmc-form">
                ...
                <div class="form-group">
                    <label for="project_pepitizy_id">ID Pepitizy du projet</label>
                    <input type="text" id="project_pepitizy_id" name="pepitizy_id" placeholder="Entrez l'ID Pepitizy" class="regular-text">
                    <p class="description">Cet ID sera utilisé pour vous rediriger vers le projet Pepitizy.</p>
                </div>
                    ...
                    <div class="project-card <?php echo $supervisor_filter > 0 ? 'filtered-project' : ''; ?>"
                        ...
                        <div class="project-header">
                            ...
                            <div class="project-actions">
                                ...
                                <button class="button button-small set-pepitizy-id-project-btn" data-project-id="<?php echo $project->id; ?>">
                        ...
                        <div class="project-content">
                            ...
                            <?php if (!empty($project->pepitizy_id)): ?>
                                <div class="project-pepitizy-link">
                                    <a href="https://pepite-eca.pepitizy.fr/fr/admin/projects/<?php echo esc_attr($project->pepitizy_id); ?>/reports/list" 
                                       target="_blank" 
                                       class="button button-primary pepitizy-project-btn">
                                        <i class="fas fa-external-link-alt"></i>
                                        Voir le projet Pepitizy
                                    </a>
                                </div>
                            <?php endif; ?>
                        </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="edit-project-form">
                ...
                <div class="form-field">
                    <label for="edit_project_pepitizy_id">ID Pepitizy du projet</label>
                    <input type="text" id="edit_project_pepitizy_id" name="pepitizy_id" placeholder="Entrez l'ID Pepitizy" class="regular-text">
                    <p class="description">Cet ID sera utilisé pour vous rediriger vers le projet Pepitizy.</p>
                </div>
            </form>
        </div>
...
<!-- Modal pour définir l'ID Pepitizy -->
<div id="set-pepitizy-id-modal" class="wp-bmc-modal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
            <h3>Définir l'ID Pepitizy</h3>
            <button class="modal-close">&times;</button>
        </div>

        <div class="modal-body">
            <form id="set-pepitizy-id-form">
                <div class="form-field">
                    <label for="pepitizy-id-input">ID Pepitizy du projet</label>
                    <input type="text" id="pepitizy-id-input" name="pepitizy_id" placeholder="Entrez l'ID Pepitizy" class="regular-text">
                    <p class="description">Cet ID sera utilisé pour vous rediriger vers le projet Pepitizy.</p>
                </div>
            </form>
        </div>
        ...
        <div class="modal-footer">
            <button type="button" class="button button-primary" id="save-pepitizy-id-btn">
                <i class="fas fa-save"></i> Enregistrer
            </button>
            <button type="button" class="button button-secondary modal-close">Annuler</button>
        </div>
