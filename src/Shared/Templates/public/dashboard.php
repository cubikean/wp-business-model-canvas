...
$canvas_data_meta = $project_id ? WP_BMC_Database::get_canvas_data($project_id, true) : array();
$canvas_data = array();
$canvas_versions = array();

foreach ($canvas_data_meta as $section => $entry) {
...
var wp_bmc_canvas_versions = <?php echo wp_json_encode($canvas_versions); ?>;
</script>
